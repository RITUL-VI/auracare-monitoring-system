...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Contact-free vitals monitoring from a live camera feed.",
      },
      { name: "author", content: "AuraCare" },
      { property: "og:title", content: "AuraCare" },
      { property: "og:description", content: "Contact-free vitals monitoring." },
